...
from frozen.ram_map import W_CUR_MAP, W_X_COORD, W_Y_COORD
...
class StreamWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        x_pos = self.emulator.memory[W_X_COORD]
        y_pos = self.emulator.memory[W_Y_COORD]
        map_n = self.emulator.memory[W_CUR_MAP]
